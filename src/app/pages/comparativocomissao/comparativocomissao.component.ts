...
import { MatDatepicker, DateAdapter, MAT_DATE_LOCALE, MAT_DATE_FORMATS, MatDatepickerInputEvent } from '@angular/material';
...
@Component({
    selector: 'app-comparativocomissao',
    templateUrl: './comparativocomissao.component.html',
    styleUrls: ['./comparativocomissao.component.css'],
    providers: [
        {
            provide: DateAdapter,
...
export class ComparativoComissaoComponent implements OnInit {
    viewDateA = new Date();
    viewDateB = new Date();
